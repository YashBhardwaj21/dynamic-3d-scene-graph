...
def test_causal_tracker_lifecycle(tracker_config):
    ...
    tracker.update([], 5) # missing=2
    tracker.update([], 6) # missing=3
    tracker.update([], 7) # missing=4
    tracks = tracker.update([], 8) # missing=5 -> LOST
